...
LDFLAGS := "-X github.com/simplesurance/baur/v1/version.GitCommit=$(GIT_COMMIT) \
	    -X github.com/simplesurance/baur/v1/version.Version=$(VERSION) \
	    -X github.com/simplesurance/baur/v1/version.Appendix=$(GIT_DIRTY)"
